...
#SBATCH --array=0-29                 # 2 configs × 5 seeds x 1 Reg = 10 jobs
...
CONFIG_FILES=("config_l1_0.2.json" "config_l1_1.json" "config_l2_0.2.json" "config_l2_1.json" "config_noReg_1.json" "config_noReg_0.2.json")
SEEDS=(1 2 3 4 5)
